        ...
        <div className="flex flex-col gap-4 m-5">
          ...
          <div className="flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white">
            ...
            <div className="flex items-center gap-2 mt-1 text-gray-600">
              ...
              <p className="py-0.5 px-2 border text-xs rounded-full"> {profileData.experience} years of experience</p>
            </div>
            ...
            <div className="flex gap-1 pt-2">
              <input type="checkbox"checked={profileData.available}
            ...
            {
            isEdit && (
              <button onClick={() => setIsEdit(false)} className="px-4 py-1 ml-4 border border-red-500 text-sm rounded-full mt-5 hover:bg-red-500 hover:text-white transition-all">
                Cancel
              </button>
            )}
