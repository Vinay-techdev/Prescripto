...
const AllAppointments = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white rounded text-sm max-h-[80h] min-h-[60vh] overflow-y-scroll'>

        <div className='hidden sm:grid grid-cols-[0.5fr_1fr_3fr_3fr_1fr_1fr] grid-flow-col py-3 px-6 border-b'>
          <p>#</p>
          <p>Patient</p>
          <p>Age</p>
          <p>Date & Time</p>
