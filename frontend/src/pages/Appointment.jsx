...
const Appointment = () => {
  ...
  const daysOfWeek = ["SUN", "MON", "TUE", "WED ", "THU", "FRE", "SAT ", "SAT"];
    ...
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div>
            <img className="bg-[#5f6FFF] w-full sm:max-w-72 rounded-lg" src={docInfo.image} alt={docInfo.name}/>
          </div>
          ...
          <div className="flex gap-3 items-center w-full overflow-x-scroll mt-4">
            ...
            docSlots.length &&
              docSlots.map((item, index) => (
                ...
                <div key={index} onClick={() => setSlotIndex(index)} className={`text-center py-6 min-w-16 rounded-full cursor-pointer ${slotIndex === index ? "bg-[#5f6FFF] text-white": "border border-gray-200"} `}>
          ...
          <div className="flex items-center gap-3 w-full overflow-x-scroll mt-4">
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => (
                ...
                <p key={index} onClick={() => setSlottime(item.time)} className={`text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer ${item.time === slotTime ? "bg-[#5f6FFF] text-white" : "text-gray-400 border border-gray-300"} `}>
